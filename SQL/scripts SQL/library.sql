...
GRANT SELECT,INSERT ON libraryT.books TO 'userB'@'localhost';
GRANT SELECT,INSERT ON libraryT.magazine TO 'userB'@'localhost';
GRANT SELECT,INSERT ON libraryT.newspaper TO 'userB'@'localhost';
GRANT SELECT,INSERT ON libraryT.user TO 'userB'@'localhost';
...
FLUSH PRIVILEGES;
*/
CREATE TRIGGER beforeDeleteToWareHouse AFTER DELETE ON loan 
FOR EACH ROW
...
CREATE TRIGGER beforeDeleteToWareHouse AFTER DELETE ON Product 
FOR EACH ROW
...
CREATE TRIGGER beforeDeleteToWareHouseBackup AFTER DELETE ON Warehouse
FOR EACH ROW
