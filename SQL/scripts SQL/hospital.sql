...
CREATE TABLE datos_personales(
	id_datap int PRIMARY KEY NOT NULL AUTO_INCREMENT,
	id_pacientee int NOT NULL, 
	...
	lugar_nacimiento VARCHAR(30) NOT NULL,
	 ...
	 foreign key(id_pacientee)references paciente(id_paciente)
);
CREATE TABLE domicilio(
	id_dom INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
	id_pacientee int NOT NULL,
...
CREATE TABLE medicamento(
	...
	id_paciente int NOT NULL,precio DECIMAL(5,2)NOT NULL
);
CREATE TABLE fabricacion(
	id_fabri int PRIMARY KEY NOT NULL AUTO_INCREMENT,
	id_medicamentoo int NOT NULL,
	nombre varchar(50)NOT NULL,
	cantidad int NOT NULL, 
	tipo_medicina VARCHAR(50) NOT NULL,
	lugar_fabricacion VARCHAR(40) NOT NULL,
	fecha_cadocidad DATE NOT NULL,
	descripcion LONGTEXT NOT NULL,
	foreign key(id_medicamentoo)references medicamento(id_medicamento)
	);
CREATE TABLE servicios(
	id_servicios int PRIMARY KEY NOT NULL AUTO_INCREMENT,
	id_pacientee int NOT NULL,precio DECIMAL(5,2)NOT NULL
);
CREATE TABLE doctor(
	id_doc int PRIMARY KEY NOT NULL AUTO_INCREMENT,
	id_servicioss int NOT NULL,
	nombre VARCHAR(50) NOT NULL,
	cedula_n VARCHAR(50) NOT NULL,
	ramade_estudio VARCHAR(50) NOT NULL,
	foreign key(id_servicioss)references servicios(id_servicios)
);
CREATE TABLE diagnostico(
	id_diag int PRIMARY KEY NOT NULL AUTO_INCREMENT ,
	id_servicioss int NOT NULL,
	problematica LONGTEXT NOT NULL,
...
/*DESKTOP-M270QPE (DESKTOP-M270QPE\martin)
name */