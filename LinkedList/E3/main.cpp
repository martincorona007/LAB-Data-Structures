    ...
    do{
        ...
        switch(op){
            ...
            case 9:
                ...
                break;
            case 10:
                std::cout<<"\n->Disordered Search<-"<<endl;
                printf("Write the number to search: ");
                cin>>N;
                res=k.disorderedSearch(N);
                printf("Number in the list: ");
