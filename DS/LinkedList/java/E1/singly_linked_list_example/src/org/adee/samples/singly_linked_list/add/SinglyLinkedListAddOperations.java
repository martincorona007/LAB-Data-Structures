package org.adee.samples.singly_linked_list.add;

public class SinglyLinkedListAddOperations {
	...
	public static void main(String[] args) {
		SinglyLinkedListAddOperations list = new SinglyLinkedListAddOperations();
